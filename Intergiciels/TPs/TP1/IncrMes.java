...
public class IncrMes {
    ...
    public static void main(String[] args) {
        ...
        lancer(nbActivités, new IncrémenteurNonSyncIn());
        finir();
        fin = System.nanoTime();
...
class IncrémenteurNonSyncIn implements Incrémenteur {
 ...
 */
    public void incr() {
        ...
        // pour vérifier la cohérence des incrémentations
         System.out.println("avant le verrou " + Thread.currentThread().getName() + " : " +IncrMes.cpt);
        this.incr();
        System.out.println("après le verrou " + Thread.currentThread().getName() + " : "+ IncrMes.cpt);
    }
   }
 class IncrémenteurNonSyncOut implements Incrémenteur {
    ...
    public void incr() {
     ...
     public void run() {
        ...
        System.out.println("avant le verrou t :   " + Thread.currentThread().getName() + " : " + IncrMes.cpt);
        this.incr();
        System.out.println("après le verrou t : " + Thread.currentThread().getName() + " : "+ IncrMes.cpt);
    }
}
