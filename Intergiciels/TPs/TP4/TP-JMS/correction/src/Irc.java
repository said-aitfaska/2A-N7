...
class readListener implements MessageListener {
	...
	public void onMessage(Message msg)  {
		try {
			...
			//System.out.println("check point " + cmd);

			if (cmd.equals("say")) {
				Irc.print(smsg.readString());
				//System.out.println("check point - say - smsg - : " + smsg.readString());
				...
				//System.out.println("niveau enter iamhere");
				//System.out.println("check point - enter - : " + ((StreamMessage)m).readString());
